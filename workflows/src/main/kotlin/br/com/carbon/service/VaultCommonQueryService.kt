...
open class VaultCommonQueryService(val service: AppServiceHub) : SingletonSerializeAsToken() {
    ...
    fun getCustomFungiblesOfAccount(accountInfo: AccountInfo, tokenIdentifier: String) : Vault.Page<CustomFungibleToken> {
        val identifierCriteria = builder {
            CustomPersistentFungibleToken::tokenIdentifier.equal(tokenIdentifier)
        }
